      ...
      <div>
        ...
        <div className={styles.cardContainer}>
          ...
          <div className={styles.infoHistory}>
            ...
            <p className={styles.yearDescription}>
              Este evento fue un punto de inflexión para el desarrollo económico
              y poblacional de la ciudad, ya que permitió el transporte de
              bienes y personas a otras partes del país. Además, el edificio del
              ferrocarril se convirtió en un importante centro de intercambio
              comercial y social
            </p>
          </div>
          <HistoryCard
        ...
        <div className={styles.cardContainer}>
          ...
          <div className={styles.infoHistory}>
            ...
            <p className={styles.yearDescription}>
              Antes de su construcción, los habitantes utilizaban el lugar para
              jugar al fútbol. En la década del '30 se construye la plaza;
              posteriormente, la rotonda central, que se utilizaba para que
              tocara la banda local, la cual era subvencionada por la
        ...
        <div className={styles.cardContainer}>
          ...
          <div className={styles.infoHistory}>
            ...
            <p className={styles.yearDescription}>
              ...
              mejora significativa en la gestión y administración de la ciudad.
              Además, se crearon nuevas escuelas y servicios públicos, como el
              hospital y la policía local, mejorando la calidad de vida y
              fomentando el desarrollo social y cultural de la ciudad.
            </p>
          </div>
          <HistoryCard
        ...
        <div className={styles.cardContainer}>
          ...
          <div className={styles.infoHistory}>
            ...
            <p className={styles.yearDescription}>
              Permitió mejorar significativamente la atención médica y de salud
              en la región, y propició el desarrollo de nuevas tecnologías y
              servicios médicos. Además, el hospital se convirtió en un
              importante centro de formación de profesionales de la salud, lo
              que contribuyó al desarrollo educativo y económico de la región.
            </p>
          </div>
          <HistoryCard
